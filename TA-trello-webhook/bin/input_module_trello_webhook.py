...
def collect_events(helper, ew):
    ...
    me = helper.send_http_request('https://api.trello.com/1/members/me', 'get', parameters=params, payload=None, headers=None, cookies=None, verify=True, cert=None, timeout=None, use_proxy=True)
    try:
        boards = me.json()['boards']
    ...
    webhooks = [w['idModel'] for w in webhooks_json if w['callbackURL'] == helper.get_arg('callback_url')]
